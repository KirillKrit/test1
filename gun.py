...
"""Документация:
    1 танк: движение происходит при нажатии на клавиши q и e, стрельба на левую кнопку мыши, прицеливание с помощью мышки
    2 танк: движение происходит с помощью клавиш управления курсором left и right, стрельб при нажатии на кнопку k, прицеливание с помощью мыши
    доп. функции: смена типа снаряда на клавишу g, танки могут убивать друг друга, так же танк может погибнуть от своего снаряда, так же есть счетчик уничтоженных мишеней
    2 типа мешеней: 1)двигающаяся хаотично, c случайной скоростью
                    2)двигающаяся по окружности 
    добавлены бомбы, котрорые можно уничтожить, но в счётчик они не идут, бомбы убивают танк при попаданиии   """
